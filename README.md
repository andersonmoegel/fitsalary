...
api/analyze.js    Funcao serverless que chama o Gemini, com fallback entre modelos e novas tentativas em caso de resposta malformada
api/fetch-link.js Funcao serverless que busca uma URL (vaga ou currículo/LinkedIn) e extrai o conteúdo relevante, com protecoes contra SSRF
package.json      Define "type": "module" para as funcoes usarem ESM
```
